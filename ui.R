    ...
    tabPanel(
        ...
        tabsetPanel(
            ...
            tabPanel(
                ...
                hr(),
                tags$h1("GitHub"),
                tags$p(HTML("Source code is available at <a href=\"https://github.com/zhuziyi1112/Global_IT_Consulting_Engagement_Utilization_ShinyApp.git\">https://github.com/</a>."))
            ),
